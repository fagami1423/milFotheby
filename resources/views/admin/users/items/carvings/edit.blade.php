...
@section('content')
    ...
    <section id="main-content">
            <section class="wrapper">
              <div class="row">
                  <div class="col-lg-12">
                      <h3 class="page-header"><i class="fa fa-file-text-o"></i> Craving</h3>
                      <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="/admin">Home</a></li>
                        <li><i class="icon_document_alt"></i>Craving</li>
                ...
                <div class="col-lg-12">
                  <section class="panel">
                    ...
                    <div class="panel-body">
                            {!! Form::open(['action'=>['\App\Http\Controllers\Item\CarvingController@update',$model->id],'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="form-group">
                                ...
                                {{Form::text('material', $model->material, ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
