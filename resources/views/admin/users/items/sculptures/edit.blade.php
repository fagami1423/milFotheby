                ...
                <div class="col-lg-12">
                  <section class="panel">
                    <header class="panel-heading">
                      Edit a sculpture item
                    </header>
                    <div class="panel-body">
                            {!! Form::open(['action'=>['\App\Http\Controllers\Item\SculptureController@update',$model->id],'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="form-group">
                                    ...
                                    {{Form::text('dimension', $model->weight, ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
