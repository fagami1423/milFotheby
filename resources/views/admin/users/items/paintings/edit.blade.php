...
@section('content')
    ...
    <section id="main-content">
            <section class="wrapper">
              <div class="row">
                  <div class="col-lg-12">
                      <h3 class="page-header"><i class="fa fa-file-text-o"></i> Paintings</h3>
                      <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="/admin">Home</a></li>
                        <li><i class="icon_document_alt"></i>Paintings</li>
                ...
                <div class="col-lg-12">
                  <section class="panel">
                    <header class="panel-heading">
                      edit a painting item
                      @if (\Session::has('success'))
                      <div class="alert alert-info">{{ \Session::get('success') }}</div>
                      @endif
                    </header>
                    <div class="panel-body">
                            {!! Form::open(['action'=>['\App\Http\Controllers\Item\PaintingController@update',$model->id],'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="form-group">
                                    ...
                                    {{Form::text('medium', $model->medium, ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
                                    {{Form::label('frame', 'Framed')}}
                                    {{Form::text('frame', $model->frame, ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
