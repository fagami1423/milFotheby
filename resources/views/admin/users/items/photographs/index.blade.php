                ...
                <div class="col-lg-12">
                  <section class="panel">
                    <header class="panel-heading">
                      Photographs Items
                      <a class="pull-right" href='{{route("photograph.create")}}'>
                                                ...
                                                @if($results->count())
                                                    @foreach($results as $result)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('photograph.edit',['id'=>$result->id])}}"
                                                                   class="btn btn-primary">Edit</a>
                                                                <a href="{{route('photograph.destroy',['id'=>$result->id])}}" class="btn btn-danger">Delete</a>
                                                            </td>
