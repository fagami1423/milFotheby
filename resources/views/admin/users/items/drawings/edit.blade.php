                ...
                <div class="col-lg-12">
                  <section class="panel">
                    ...
                    <div class="panel-body">
                            {!! Form::open(['action'=>['\App\Http\Controllers\Item\DrawingController@update',$model->id],'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="form-group">
                                    ...
                                    {{Form::text('frame', $model->framed, ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
