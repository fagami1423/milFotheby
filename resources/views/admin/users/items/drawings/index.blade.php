                ...
                <div class="col-lg-12">
                  <section class="panel">
                    <header class="panel-heading">
                      Drawings Items
                      <a class="pull-right" href='{{route("drawing.create")}}'>
                                                ...
                                                @if($results->count())
                                                    @foreach($results as $result)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('drawing.edit',['id'=>$result->id])}}"
                                                                   class="btn btn-primary">Edit</a>
                                                                <a href="{{route('drawing.destroy',['id'=>$result->id])}}" class="btn btn-danger">Delete</a>
                                                            </td>
